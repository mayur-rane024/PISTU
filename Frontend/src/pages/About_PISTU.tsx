...
const About_Pistu = () => {
  return (
    <>
      <Navbar />
      <div className="mt-10 min-h-screen flex items-center justify-center bg-[#fdf2e3] px-80 py-10 w-full  p-8 text-gray-800 flex-col rounded-lg text-center">
        <img
          alt="mandala left"
          src="./mandala-left.png"
          className="absolute mt-45  left-0 top-0 w-1/6 h-auto opacity-60"
        />
        <img
          alt="mandala right"
          src="./mandala-right.png"
          className="absolute mt-45 right-0 top-0 w-1/6 h-auto opacity-60"
        />
        ...
        <p
          className="mb-4 text-[#5e4c3f] text-lg"
        ...
        <div
          className="px-20 text-[#5e4c3f] text-sm"
          style={{ fontFamily: "font6" }}
        >
          <p className="mb-4">
