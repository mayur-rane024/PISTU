const Disclaimer = () => {
  return (
    <div className="min-h-screen flex items-center justify-center sm:px-80 px-10 py-10 w-full bg-transparent text-gray-800 flex-col shadow-lg rounded-lg text-center relative">
