    ...
    <div>
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#fdf2e3] w-full sm:px-80 px-10 py-10 text-gray-800 flex-col rounded-lg text-center relative">
        <img
          ...
          className="absolute mt-10 left-0 top-15 w-1/4 sm:w-1/5 h-auto opacity-60"
        />
        <img
          alt="mandala right"
          src="./mandala-right.png"
          className="absolute mt-10 right-0 top-15 w-1/4 sm:w-1/5 h-auto opacity-60"
        />
        ...
        >
          At <strong>PISTU</strong>, we use cookies to enhance the user
        ...
        <div className="w-full">
          ...
          >
            ...
            visit a website. They help us track your activity and personalize
