...
const Privacy_Policy = () => {
  return (
    <div>
      <Navbar />
      <div className="relative mt-12 min-h-screen flex items-center justify-center bg-[#fdf2e3] w-full sm:px-80  px-10 py-10 flex-col rounded-lg text-center">
        <img
          alt="mandala left"
        ...
        >
          At <strong>PISTU (Pigment Art and Design Studio)</strong>, we
          prioritize your privacy and are dedicated to safeguarding your
        ...
        <div className="w-full max-w-4xl px-2 sm:px-6 md:px-10 lg:px-20">
          ...
          <div
            className="text-sm text-[#5e4c3f]"
            style={{ fontFamily: "font6" }}
          >
            <p className="mb-2">
              Personal information (e.g., name, email, phone number) when you
          ...
          >
            <p className="mb-4">
              ...
              except for service providers such as payment processors and
              delivery services.
            </p>
          </div>
          ...
          >
            <p className="mb-2">
              Our website uses cookies to collect data for performance
              analytics. You can manage or disable cookies through your browser
              settings.
            </p>
          </div>
