const Refund_and_Returns_Policy = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#fdf2e3] w-full sm:px-80 px-10 py-10 text-gray-800 flex-col rounded-lg text-center relative">
      ...
      <h2 className="text-lg sm:text-xl font-bold mt-4 mb-2" style={{ fontFamily: "font5" }}>
        Returns
      </h2>
      ...
      <h2 className="text-lg sm:text-xl font-bold mt-2 mb-2" style={{ fontFamily: "font5" }}>
        Refunds
      </h2>
      <p className="mb-4 text-sm" style={{ fontFamily: "font6" }}>
      ...
      <h3 className="text-lg sm:text-xl font-bold mt-2 mb-2" style={{ fontFamily: "font5" }}>
        Return Shipping
      </h3>
      <p className="mb-4 text-sm" style={{ fontFamily: "font6" }}>
