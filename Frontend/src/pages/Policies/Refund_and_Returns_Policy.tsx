    ...
    <div>
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#fdf2e3] w-full sm:px-80 px-10 py-10 text-gray-800 flex-col rounded-lg text-center relative">
        <img
          ...
          className="absolute top-15 left-0 w-1/4 sm:w-1/5 h-auto opacity-60 mt-10"
        />
        <img
          alt="mandala right"
          src="./mandala-right.png"
          className="absolute top-15 right-0 w-1/4 sm:w-1/5 h-auto opacity-60 mt-10"
        />
        ...
        <h2
          className="text-lg sm:text-xl font-bold mt-4 mb-2 text-[#342b24]"
          style={{ fontFamily: "font5" }}
        >
          Returns
        </h2>
        <p
          className="mb-2 text-sm text-[#5e4c3f]"
          style={{ fontFamily: "font6" }}
        >
          Returns are accepted within 10 days from the date of delivery.
          Returned items must be unused, in original packaging, and in the same
        ...
        <h2
          className="text-lg sm:text-xl font-bold mt-2 mb-2 text-[#342b24]"
          style={{ fontFamily: "font5" }}
        >
          Refunds
        </h2>
