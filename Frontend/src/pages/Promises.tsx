...
const OurPromise: React.FC = () => {
  return (
    <section className="bg-white/90 backdrop-blur-lg py-16 px-4 h-[85vh] text-center">
      <img
        alt="mandala left"
        src="./mandala-left.png"
        className="absolute  mt-15  left-0 top-0 w-1/6 h-auto opacity-55"
      />
      <img
        alt="mandala right"
        src="./mandala-right.png"
        className="absolute  mt-15 right-0 top-0 w-1/6 h-auto opacity-55"
      />
      <div className="mt-10">
        <h2
          className="text-4xl text-[#342b24] mb-4"
          style={{ fontFamily: "font5" }}
        >
          Our Promise
        </h2>
        <p
          className="text-lg text-[#3A2E25] max-w-2xl mx-auto mb-12"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3
              className="text-2xl font-serif text-[#342b24] mb-2"
              style={{ fontFamily: "font6" }}
            >
              Exceptional Quality
            </h3>
            <p
              className="text-[#3A2E25] max-w-sm text-sm"
              style={{ fontFamily: "font6" }}
            >
