...
const products = [
  ...
  { name: "Rustic gathered top BEIGE", price: "$27.90 - $35.90", image: img1, hoverImage: "https://via.placeholder.com/300x320?text=Hover+Beige+Top" },
  { name: "Rustic gathered top ECRU", price: "$27.90", image: img1, hoverImage: "https://via.placeholder.com/300x320?text=Hover+Ecru+Top" },
  { name: "Striped short sleeve T-shirt BROWN", price: "$17.90 - $45.90", image: img1, hoverImage: "https://via.placeholder.com/300x320?text=Hover+Brown+T-Shirt" },
  { name: "Striped short sleeve T-shirt PALE BLUE", price: "$17.90", image: img1, hoverImage: "https://via.placeholder.com/300x320?text=Hover+Pale+Blue+T-Shirt" },
  { name: "T-shirt with cowboy and heart graphic FADED BLUE", price: "$35.90 - $47.90", image: img1, hoverImage: "https://via.placeholder.com/300x320?text=Hover+Faded+Blue+T-Shirt" },
];

// Categories for the buttons
const categories = [
  { name: "All Category", path: "/products" },
  { name: "Belts", path: "/products/belt" },
  { name: "Bags", path: "/products/bags" },
  { name: "Purse", path: "/products/purse" },
      ...
      <main className="flex-grow p-8 px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-6">
          {products.map((product, index) => {
            ...
            return (
              <Link
                to={`/category/${categoryName}/${product.name.toLowerCase()}`}
                key={index}
                className=""
              >
                <div
