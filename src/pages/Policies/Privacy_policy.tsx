const Privacy_Policy = () => {
  return (
    <div className="mt-10 min-h-screen flex items-center justify-center bg-[#fdf2e3] px-80 py-10 w-full bg-tranparent p-8 text-gray-800  flex-col rounded-lg text-center">
      ...
      <p className="mb-4 text-[#5e4c3f]" style={{ fontFamily: "font6" }}>
...
<div className="px-20"><h2
        className="text-xl font-semibold mt-6 mb-2 text-[#342b24]"
        style={{ fontFamily: "font5" }}
      >
      ...
      <h2
        className="text-xl font-semibold mt-4 mb-2 text-[#342b24]"
        style={{ fontFamily: "font5" }}
      >
        Your Rights
      </h2>
